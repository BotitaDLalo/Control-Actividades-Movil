...
class _CustomExpansionState extends ConsumerState<GroupsSubjectsContainer> {
  ...
  Widget build(BuildContext context) {
    ...
    // 3. FILTRADO LOCAL: Filtramos la lista 'groups.lsGroups' aquí mismo
    final filteredGroups = groups.lsGroups.where((element) {
